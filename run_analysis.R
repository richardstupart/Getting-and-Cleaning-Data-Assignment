...
activitylabels.df <- read.table('./data/activity_labels.txt', header = FALSE)

features.df <- read.table("./data/features.txt", header = FALSE)

#Process Training Data
#====================================================================================================
#Read in the training data
train.subjects.df <- read.table("./data/train/subject_train.txt", header = FALSE)
train.x.df <- read.table("./data/train/x_train.txt", header = FALSE)
train.y.df <- read.table("./data/train/y_train.txt", header = FALSE)
...
test.subjects.df <- read.table("./data/test/subject_test.txt", header = FALSE)
test.x.df <- read.table("./data/test/x_test.txt", header = FALSE)
test.y.df <- read.table("./data/test/y_test.txt", header = FALSE)
